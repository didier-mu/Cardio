...
function valCombos(s){$(s).each(function(){$(this).change(function(){null!=$(this).val()&&$(this).parents(".combo").siblings("msjError").remove()}),null==$(this).val()&&($(this).parents(".combo").siblings(".msjError").remove(),$(this).parents(".combo").after('<span class="msjError show"> Campo requerido </span>'))})}function validacionSesion2(s){0==$(s).prop("checked")?s.siblings(".msjError").css("display","block"):s.siblings(".msjError").hide().removeClass("show")}$(".checkmark, .check label").on("click",function(){console.log($(this).siblings("input").prop("checked")),0==$(this).siblings("input").prop("checked")?($(this).siblings(".msjError").hide().removeClass("show"),$(this).siblings("input").prop("checked")):($(this).siblings("input").removeAttr("checked"),$(this).siblings(".msjError").addClass("show"))}),$("#selectEdo").on("change",function(){$("#linkBoton").attr({href:$(this).val(),target:"_blank"}),$(".comboBox .msjError").hide().removeClass("show")}),$(document).ready(function(){$("#boton-buscar").on("click",function(s){var o=$("#checkEdad"),i=$("#checkLegale");return validacionSesion2(o),validacionSesion2(i),valCombos($("#selectEdo")),0==$(".msjError.show").length})});
