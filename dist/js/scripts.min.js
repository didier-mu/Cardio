...
function valCombos(o){$(o).each(function(){$(this).change(function(){null!=$(this).val()&&$(this).parents(".combo").siblings("msjError").remove()}),null==$(this).val()&&($(this).parents(".combo").siblings(".msjError").remove(),$(this).parents(".combo").after('<span class="msjError show"> Campo requerido </span>'))})}function validacionSesion2(o){0==$(o).prop("checked")?o.siblings(".msjError").css("display","block"):o.siblings(".msjError").hide().removeClass("show")}$(document).ready(function(){$("#boton-buscar").on("click",function(o){var s=$("#checkEdad"),e=$("#checkLegale");return validacionSesion2(s),validacionSesion2(e),valCombos($("#selectEdo")),0==$(".msjError.show").length?(console.log("hecho"),window.dataLayer=window.dataLayer||[],window.dataLayer.push({event:"buscarData"}),!0):(console.log("no hecho"),!1)}),$(".checkmark, .check label").on("click",function(){0==$(this).siblings("input").prop("checked")?($(this).siblings(".msjError").hide().removeClass("show"),$(this).siblings("input").prop("checked")):($(this).siblings("input").removeAttr("checked"),$(this).siblings(".msjError").addClass("show"))}),$("#selectEdo").on("change",function(){$("#linkBoton").attr({href:$(this).val(),target:"_blank"}),$(".comboBox .msjError").hide().removeClass("show")})});
